#############################################################################
##  find_patch_sets_for_expansion_target: function to generate set of possible solutions
...
#'
  ...
  find_patch_sets_for_expansion_target <- function(xy, sfind, nmax, tmax=100000000000000000000000000){
