...
### =========================================================================
### B- Calculating probabilistic predictions using randomForest package
### =========================================================================

#To calculate the entropy measures on the ensemble we need 
#instance wise probablistic predictions across all trees. This is not natively
#produced by the randomForests implementation however it can be extracted
...
#train an randomForest::rf model
...
#TO DO: FINISH PREDICTION ON TEST SET, RETURNING TREE WISE PROBABILISTIC
